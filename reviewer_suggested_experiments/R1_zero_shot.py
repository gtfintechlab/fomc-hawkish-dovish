...
def train_lm_price_change_experiments(gpu_numbers: str, train_data_path_prefix_1: str, train_data_path_prefix_2: str, test_data_path_prefix: str, language_model_to_use: str, data_category: str):
    """
    ...
    for i, seed in enumerate(seeds):
        for k, batch_size in enumerate(batch_sizes):
            for j, learning_rate in enumerate(learning_rates):
                ...
                train_data_path_1 = train_data_path_prefix_1 + "-" + str(seed) + ".xlsx"
                train_data_path_2 = train_data_path_prefix_2 + "-" + str(seed) + ".xlsx"
                df_1 = pd.read_excel(train_data_path_1)
                df_2 = pd.read_excel(train_data_path_2)
                df = pd.concat([df_1, df_2],    # Combine vertically
                          ignore_index = True,
                          sort = False)
                train_data_path = "temp_exp.xlsx"
                df.to_excel(train_data_path, index=False)
...
if __name__=='__main__':
    ...
    train_data_path_prefix_1 = "../training_data/test-and-training/training_data/" + "lab-manual-mm" + "-train"
    train_data_path_prefix_2 = "../training_data/test-and-training/training_data/" + "lab-manual-pc" + "-train"
    test_data_path_prefix = "../training_data/test-and-training/test_data/" + "lab-manual-sp" + "-test"


    train_lm_price_change_experiments(gpu_numbers="0", train_data_path_prefix_1=train_data_path_prefix_1, train_data_path_prefix_2=train_data_path_prefix_2, test_data_path_prefix=test_data_path_prefix, language_model_to_use=language_model_to_use, data_category="R1_zero_shot")
