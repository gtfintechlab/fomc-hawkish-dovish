...
files = pd.read_excel(
    "/Users/suvanpaturi/Documents/Meeting-Minutes-Datasets/master_meeting_minutes_1996_2020_cleanmeta_NLP_v4.xlsx")[
    'Url'].tolist()
...
def export_text(text, name):
    file = open("/Users/suvanpaturi/Documents/Meeting-Minutes/" + name + ".txt", "w")
    file.write(text)
    file.close()
